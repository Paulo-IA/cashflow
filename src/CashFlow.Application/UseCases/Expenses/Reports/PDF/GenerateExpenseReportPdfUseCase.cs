...
public class GenerateExpenseReportPdfUseCase : IGenerateExpenseReportPdfUseCase
{
    ...
    private Document CreateDocument(DateTime month)
    {
        ...
        document.Info.Author = "Paulo Fernandes";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "picture.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Hey, Paulo Fernandes");
        row.Cells[1].Format.Font = new Font { Name = FontHelper.RALEWAY_BLACK, Size = 16 };
        row.Cells[1].VerticalAlignment = MigraDoc.DocumentObjectModel.Tables.VerticalAlignment.Center;
    }

    private void CreateTotalExpenseSection(Section page, DateTime month, decimal totalExpenses)
    {
